...
src_dir="/stor/scratch/Ochman/kristen/bacterial_species_CDSs"
base_dest_dir="/stor/scratch/Ochman/kristen/pangenome/all_bacterial_species"

# Loop through each CDS fasta file in the source directory
for file in ${src_dir}/*_cds.fna; do
    ...
    species_dest_dir="${base_dest_dir}/${species}/${species}_CDSs"
