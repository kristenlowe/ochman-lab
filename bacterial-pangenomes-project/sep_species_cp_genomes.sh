...
src_dir="/stor/scratch/Ochman/kristen/bacterial_species_genomes"
base_dest_dir="/stor/scratch/Ochman/kristen/pangenome/all_bacterial_species"

# Loop through each genome fasta file in the source directory
for file in ${src_dir}/*_genome.fna; do
    ...
    species_dest_dir="${base_dest_dir}/${species}/${species}_genomes"
